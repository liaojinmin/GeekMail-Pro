...
public final class Template {
    ...
    private static final Map<String, Temp> TEMP_PACK_MAP = new HashMap<>();
    ...
    public static void onLoad() {
        ...
        for (File f : list) {
           ...
           // MailType type = MailType.valueOf(var1.getString("Template.package.type"));
            ...
            TEMP_PACK_MAP.put(PackID, new TempPack(PackID, condition, action, deny, title, text, appendix));
    ...
    public static Map<String, Temp> getTempPackMap() {
        return TEMP_PACK_MAP;
    }

    public static Temp getTempPack(String key) {
